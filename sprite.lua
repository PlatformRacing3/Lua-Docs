...
---- 
--- @see endFill
--- @see @{utils.GradientType|GradientType}
--- @see @{utils.GradientSpreadMethod|GradientSpreadMethod}
--- @see @{utils.ColorInterpolationMethod|ColorInterpolationMethod}
...
--- @see @{utils.CapsStyle|CapsStyle}
--- @see @{utils.JointStyle|JointStyle}
...
--- @see @{utils.GraphicsPathWinding|GraphicsPathWinding}
...
---- 
--- @see @{utils.TextFormatAlign|TextFormatAlign}
